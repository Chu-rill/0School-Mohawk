...
/**
 * Represents Player 2's game piece. It is drawn as a brown circle.
...
public class Player2Piece extends GamePiece {
    ...
    /**
     * Draws this piece as a brown circle inside the given cell. If the piece is
    ...
    public void draw(GraphicsContext gc, int row, int col, int size, boolean selected) {
        ...
        // draw the brown circle, leaving a small margin inside the cell
        int margin = 5;
